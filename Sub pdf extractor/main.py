...
if __name__ == "__main__":
    input_pdf_path = r"E:\vu\Handouts\cs401_assembly_language(_79_).pdf"
    output_folder = r"C:\Users\PCS\Downloads\cs401"

    start_page = 103  # <-- Change as needed
    end_page = 112 # <-- Change as needed
