...
"""
╔══════════════════════════════════════════════════════════════╗
║     Unicode Urdu Novel -> InPage Converter  |  v4.2      ║
║                                                              ║
║  Handles:                                                    ║
║  ✓ Urdu text (complete alphabet + diacritics)                ║
║  ✓ Arabic text in duas (ه ك ة ى إ etc.)                      ║
║  ✓ Fixed [ bug: إ ab sahi ا render hoga                      ║
║  ✓ English text RTL fix (Congrats Alia! sahi dikhega)        ║
║  ✓ Missing Space Fix: بے لوث ab بیلوث nahi banega (v4.2)     ║
╚══════════════════════════════════════════════════════════════╝
...
SYMBOL_REPLACEMENTS = {
    ...
    # --- V4.2 FIX: Invisible characters ko delete karne ki bajaye space se replace kar diya ---
...
def convert_text(text: str) -> tuple[str, set, int, int]:
    ...
    # Agar Bari Ye (ے) ya Noon Ghunna (ں) ke fauran baad koi Urdu harf aa raha hai,
    # to ye regex auto-magically us ke beech mein ek space daal de gi.
    # Is se InPage "بےلوث" ko "بے لوث" padhega aur "بیلوث" banne se rokay ga.
...
def main():
    print()
    print("╔══════════════════════════════════════════════════════╗")
    print("║    Urdu Novel -> InPage Converter  |  v4.2           ║")
    print("║    v4.2 FIX: Missing Spaces auto-fix for 'ے' & 'ں'  ║")
    print("╚══════════════════════════════════════════════════════╝")
