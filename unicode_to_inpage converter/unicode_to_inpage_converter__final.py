...
def main():
    ...
    # IMPORTANT: latin-1 nahi -- ye output mein U+00FF se bare codepoints
    # (smart quotes waghera) hain jo latin-1 mein corrupt ho jate hain.
    # utf-8-sig (BOM ke sath) Notepad ke liye sab se reliable hai.
