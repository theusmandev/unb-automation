...
def add_watermark(pdf_path, output_path):
    ...
    for page_number in range(total_pages):
        ...
        # --------------------------------------------
        # RIGHT SIDE VERTICAL WATERMARK (ROTATE = 90°)
        # --------------------------------------------
        rect = fitz.Rect(
            w - 40,     # x1 (near right edge)
            h * 0.20,   # y1 (start higher)
            w - 10,     # x2
            h * 0.80    # y2 (end near bottom)
        )
        ...
        page.insert_textbox(
            ...
            align=1          # center alignment inside rotated box
        )
