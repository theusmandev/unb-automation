...
def replace_first_page(folder_path):
    ...
    # ✨ Rename image based on PDF title
    try:
    ...
    # Step 1: Get PDF dimensions (Update: Second page size)
    try:
        reader = PdfReader(str(pdf_file))
        
        # Check if second page exists, otherwise use first page
        if len(reader.pages) > 1:
            reference_page = reader.pages[1] # Index 1 means 2nd page
            print("Using Second Page dimensions for cover.")
        else:
            reference_page = reader.pages[0]
            print("Warning: PDF has only 1 page. Using first page dimensions.")
    ...
    try:
        ...
        # Add remaining pages (skipping the original 1st page)
...
if __name__ == "__main__":
    folder_path = r"E:\unb-workstation\Writers All Novels\Anjum ansar Novels\replace"
...
# # Example run
# if __name__ == "__main__":
#     folder_path = r"E:\unb-workstation\Writers All Novels\Iqra Sagheer Ahmed\png\replace"
#     replace_first_page(folder_path)
